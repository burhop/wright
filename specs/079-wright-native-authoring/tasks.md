...
- [x] T030 Run required push/merge gates on exact candidates, inspect all terminal CI jobs and consolidate any necessary corrections. (FR-020; AC10)
...
T001 baseline inspection and T002 contracts precede product implementation. T001's prospective transition/catalog record work may proceed alongside independent native foundation code, but must complete before initial dashboard publication. Dashboard T003→T004→T005 may run independently after contracts; core T006→T007/T008 precedes persistence T009→T010→T011 and client T012→T013/T014→T015→T016. Runtime T017→T018/T019→T020→T021→T022→T023; T024→T025 requires runtime and gateway boundary. T026 requires examples/runtime. T027/T028/T029 require the affected complete candidate. For N01 scoped implementation delivery, the [prospective existing-lifecycle rule](../../docs/programs/engineering-process-platform/coordinator-state-machine.md#prospective-native-implementation-delivery-revision-98-onward) permits T030 gates and a dev PR while human study and final deployment/reporting remain explicitly pending. All required technical checks and independent review still precede merge; T030 cannot complete before its gates and CI, and T031 cannot complete before actual deployment verification. T032 and whole-milestone acceptance require the outstanding acceptance evidence. Recruit T028 participants during planning; do not delay independent work while scheduling.
