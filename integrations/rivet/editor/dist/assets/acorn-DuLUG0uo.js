...
function T(e, t) {
  return e < 65 ? e === 36 : e < 91 ? true : e < 97 ? e === 95 : e < 123 ? true : e <= 65535 ? e >= 170 && dt.test(String.fromCharCode(e)) : t === false ? false : le(e, Ae);
}
function j(e, t) {
  return e < 48 ? e === 36 : e < 58 ? true : e < 65 ? false : e < 91 ? true : e < 97 ? e === 95 : e < 123 ? true : e <= 65535 ? e >= 170 && xt.test(String.fromCharCode(e)) : t === false ? false : le(e, Ae) || le(e, ct);
}
var v = function(t, i) {
  i === void 0 && (i = {}), this.label = t, this.keyword = i.keyword, this.beforeExpr = !!i.beforeExpr, this.startsExpr = !!i.startsExpr, this.isLoop = !!i.isLoop, this.isAssign = !!i.isAssign, this.prefix = !!i.prefix, this.postfix = !!i.postfix, this.binop = i.binop || null, this.updateContext = null;
};
function k(e, t) {
  return new v(e, { beforeExpr: true, binop: t });
}
var S = { beforeExpr: true }, C = { startsExpr: true }, xe = {};
function m(e, t) {
  return t === void 0 && (t = {}), t.keyword = e, xe[e] = new v(e, t);
}
var a = { num: new v("num", C), regexp: new v("regexp", C), string: new v("string", C), name: new v("name", C), privateId: new v("privateId", C), eof: new v("eof"), bracketL: new v("[", { beforeExpr: true, startsExpr: true }), bracketR: new v("]"), braceL: new v("{", { beforeExpr: true, startsExpr: true }), braceR: new v("}"), parenL: new v("(", { beforeExpr: true, startsExpr: true }), parenR: new v(")"), comma: new v(",", S), semi: new v(";", S), colon: new v(":", S), dot: new v("."), question: new v("?", S), questionDot: new v("?."), arrow: new v("=>", S), template: new v("template"), invalidTemplate: new v("invalidTemplate"), ellipsis: new v("...", S), backQuote: new v("`", C), dollarBraceL: new v("${", { beforeExpr: true, startsExpr: true }), eq: new v("=", { beforeExpr: true, isAssign: true }), assign: new v("_=", { beforeExpr: true, isAssign: true }), incDec: new v("++/--", { prefix: true, postfix: true, startsExpr: true }), prefix: new v("!/~", { beforeExpr: true, prefix: true, startsExpr: true }), logicalOR: k("||", 1), logicalAND: k("&&", 2), bitwiseOR: k("|", 3), bitwiseXOR: k("^", 4), bitwiseAND: k("&", 5), equality: k("==/!=/===/!==", 6), relational: k("</>/<=/>=", 7), bitShift: k("<</>>/>>>", 8), plusMin: new v("+/-", { beforeExpr: true, binop: 9, prefix: true, startsExpr: true }), modulo: k("%", 10), star: k("*", 10), slash: k("/", 10), starstar: new v("**", { beforeExpr: true }), coalesce: k("??", 1), _break: m("break"), _case: m("case", S), _catch: m("catch"), _continue: m("continue"), _debugger: m("debugger"), _default: m("default", S), _do: m("do", { isLoop: true, beforeExpr: true }), _else: m("else", S), _finally: m("finally"), _for: m("for", { isLoop: true }), _function: m("function", C), _if: m("if"), _return: m("return", S), _switch: m("switch"), _throw: m("throw", S), _try: m("try"), _var: m("var"), _const: m("const"), _while: m("while", { isLoop: true }), _with: m("with"), _new: m("new", { beforeExpr: true, startsExpr: true }), _this: m("this", C), _super: m("super", C), _class: m("class", C), _extends: m("extends", S), _export: m("export"), _import: m("import", C), _null: m("null", C), _true: m("true", C), _false: m("false", C), _in: m("in", { beforeExpr: true, binop: 7 }), _instanceof: m("instanceof", { beforeExpr: true, binop: 7 }), _typeof: m("typeof", { beforeExpr: true, prefix: true, startsExpr: true }), _void: m("void", { beforeExpr: true, prefix: true, startsExpr: true }), _delete: m("delete", { beforeExpr: true, prefix: true, startsExpr: true }) }, I = /\r\n?|\n|\u2028|\u2029/, mt = new RegExp(I.source, "g");
function G(e) {
...
function Ne(e, t, i) {
  ...
  for (var s = t; s < i; s++) {
    ...
    if (G(r)) return s < i - 1 && r === 13 && e.charCodeAt(s + 1) === 10 ? s + 2 : s + 1;
  }
  return -1;
}
var Ve = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/, w = /(?:\s|\/\/.*|\/\*[^]*?\*\/)*/g, Te = Object.prototype, vt = Te.hasOwnProperty, gt = Te.toString, H = Object.hasOwn || (function(e, t) {
  return vt.call(e, t);
}), ke = Array.isArray || (function(e) {
  return gt.call(e) === "[object Array]";
}), Se = /* @__PURE__ */ Object.create(null);
function B(e) {
  return Se[e] || (Se[e] = new RegExp("^(?:" + e.replace(/ /g, "|") + ")$"));
}
function L(e) {
  return e <= 65535 ? String.fromCharCode(e) : (e -= 65536, String.fromCharCode((e >> 10) + 55296, (e & 1023) + 56320));
}
var bt = /(?:[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/, Y = function(t, i) {
  this.line = t, this.column = i;
};
Y.prototype.offset = function(t) {
  return new Y(this.line, this.column + t);
};
...
function Le(e, t) {
  for (var i = 1, s = 0; ; ) {
    var r = Ne(e, s, t);
    if (r < 0) return new Y(i, t - s);
    ++i, s = r;
  }
}
var pe = { ecmaVersion: null, sourceType: "script", onInsertedSemicolon: null, onTrailingComma: null, allowReserved: null, allowReturnOutsideFunction: false, allowImportExportEverywhere: false, allowAwaitOutsideFunction: null, allowSuperOutsideMethod: null, allowHashBang: false, checkPrivateFields: true, locations: false, onToken: null, onComment: null, ranges: false, program: null, sourceFile: null, directSourceFile: null, preserveParens: false }, we = false;
function yt(e) {
  var t = {};
  for (var i in pe) t[i] = e && H(e, i) ? e[i] : pe[i];
  if (t.ecmaVersion === "latest" ? t.ecmaVersion = 1e8 : t.ecmaVersion == null ? (!we && typeof console == "object" && console.warn && (we = true, console.warn(`Since Acorn 8.0.0, options.ecmaVersion is required.
Defaulting to 2020, but this will stop working in the future.`)), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), t.allowReserved == null && (t.allowReserved = t.ecmaVersion < 5), (!e || e.allowHashBang == null) && (t.allowHashBang = t.ecmaVersion >= 14), ke(t.onToken)) {
    var s = t.onToken;
    t.onToken = function(r) {
      return s.push(r);
    };
  }
  return ke(t.onComment) && (t.onComment = _t(t, t.onComment)), t;
}
function _t(e, t) {
...
var X = 1, W = 2, me = 4, Re = 8, Oe = 16, Be = 32, ve = 64, Fe = 128, Z = 256, ge = X | W | Z;
function be(e, t) {
  return W | (e ? me : 0) | (t ? Re : 0);
}
var ee = 0, ye = 1, O = 2, De = 3, Me = 4, Ue = 5, b = function(t, i, s) {
  this.options = t = yt(t), this.sourceFile = t.sourceFile, this.keywords = B(pt[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]);
  var r = "";
  t.allowReserved !== true && (r = oe[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3], t.sourceType === "module" && (r += " await")), this.reservedWords = B(r);
  var n = (r ? r + " " : "") + oe.strict;
  this.reservedWordsStrict = B(n), this.reservedWordsStrictBind = B(n + " " + oe.strictBind), this.input = String(i), this.containsEsc = false, s ? (this.pos = s, this.lineStart = this.input.lastIndexOf(`
`, s - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(I).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = a.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = true, this.inModule = t.sourceType === "module", this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = false, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = /* @__PURE__ */ Object.create(null), this.pos === 0 && t.allowHashBang && this.input.slice(0, 2) === "#!" && this.skipLineComment(2), this.scopeStack = [], this.enterScope(X), this.regexpState = null, this.privateNameStack = [];
...
N.canAwait.get = function() {
  for (var e = this.scopeStack.length - 1; e >= 0; e--) {
    ...
    if (t.inClassFieldInit || t.flags & Z) return false;
    if (t.flags & W) return (t.flags & me) > 0;
  }
...
var _e = { kind: "loop" }, kt = { kind: "switch" };
l.isLet = function(e) {
  ...
  if (T(s, true)) {
    for (var r = i + 1; j(s = this.input.charCodeAt(r), true); ) ++r;
    if (s === 92 || s > 55295 && s < 56320) return true;
    var n = this.input.slice(i, r);
    if (!ft.test(n)) return true;
  }
  return false;
};
...
l.parseForStatement = function(e) {
  ...
  if (this.labels.push(_e), this.enterScope(0), this.expect(a.parenL), this.type === a.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
  var i = this.isLet();
  ...
  var n = this.isContextual("let"), u = false, o = this.containsEsc, h = new re(), d = this.start, p = t > -1 ? this.parseExprSubscripts(h, "await") : this.parseExpression(true, h);
  return this.type === a._in || (u = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (t > -1 ? (this.type === a._in && this.unexpected(t), e.await = true) : u && this.options.ecmaVersion >= 8 && (p.start === d && !o && p.type === "Identifier" && p.name === "async" ? this.unexpected() : this.options.ecmaVersion >= 9 && (e.await = false)), n && u && this.raise(p.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(p, false, h), this.checkLValPattern(p), this.parseForIn(e, p)) : (this.checkExpressionErrors(h, true), t > -1 && this.unexpected(t), this.parseFor(e, p));
};
l.parseFunctionStatement = function(e, t, i) {
  return this.next(), this.parseFunction(e, Q | (i ? 0 : fe), false, t);
};
...
l.parseCatchClauseParam = function() {
  ...
  return this.enterScope(t ? Be : 0), this.checkLValPattern(e, t ? Me : O), this.expect(a.parenR), e;
};
...
l.parseLabeledStatement = function(e, t, i, s) {
  ...
  for (var o = this.type.isLoop ? "loop" : this.type === a._switch ? "switch" : null, h = this.labels.length - 1; h >= 0; h--) {
    var d = this.labels[h];
    if (d.statementStart === e.start) d.statementStart = this.start, d.kind = o;
    else break;
  }
...
l.parseClass = function(e, t) {
  ...
  for (r.body = [], this.expect(a.braceL); this.type !== a.braceR; ) {
    ...
    u && (r.body.push(u), u.type === "MethodDefinition" && u.kind === "constructor" ? (n && this.raiseRecoverable(u.start, "Duplicate constructor in the same class"), n = true) : u.key && u.key.type === "PrivateIdentifier" && wt(s, u) && this.raiseRecoverable(u.key.start, "Identifier '#" + u.key.name + "' has already been declared"));
  }
...
l.parseClassElement = function(e) {
  ...
  var t = this.options.ecmaVersion, i = this.startNode(), s = "", r = false, n = false, u = "method", o = false;
  if (this.eatContextual("static")) {
    if (t >= 13 && this.eat(a.braceL)) return this.parseClassStaticBlock(i), i;
    this.isClassElementNameStart() || this.type === a.star ? o = true : s = "static";
  }
  if (i.static = o, !s && t >= 8 && this.eatContextual("async") && ((this.isClassElementNameStart() || this.type === a.star) && !this.canInsertSemicolon() ? n = true : s = "async"), !s && (t >= 9 || !n) && this.eat(a.star) && (r = true), !s && !n && !r) {
    var h = this.value;
    (this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? u = h : s = h);
  }
  if (s ? (i.computed = false, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = s, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === a.parenL || u !== "method" || r || n) {
...
l.parseClassId = function(e, t) {
  this.type === a.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, O, false)) : (t === true && this.unexpected(), e.id = null);
};
...
l.exitClassBody = function() {
  ...
  if (this.options.checkPrivateFields) for (var s = this.privateNameStack.length, r = s === 0 ? null : this.privateNameStack[s - 1], n = 0; n < i.length; ++n) {
    var u = i[n];
    H(t, u.name) || (r ? r.used.push(u) : this.raiseRecoverable(u.start, "Private field '#" + u.name + "' must be declared in an enclosing class"));
  }
};
function wt(e, t) {
...
l.parseExportDefaultDeclaration = function() {
  ...
  if (this.type === a._function || (e = this.isAsyncFunction())) {
    var t = this.startNode();
    return this.next(), e && this.next(), this.parseFunction(t, Q | qe, false, e);
...
l.checkExport = function(e, t, i) {
  e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), H(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"), e[t] = true);
};
l.checkPatternExport = function(e, t) {
  ...
  else if (i === "ArrayPattern") for (var u = 0, o = t.elements; u < o.length; u += 1) {
    var h = o[u];
...
l.parseImport = function(e) {
  return this.next(), this.type === a.string ? (e.specifiers = St, e.source = this.parseExprAtom()) : (e.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), e.source = this.type === a.string ? this.parseExprAtom() : this.unexpected()), this.options.ecmaVersion >= 16 && (e.attributes = this.parseWithClause()), this.semicolon(), this.finishNode(e, "ImportDeclaration");
};
...
l.parseWithClause = function() {
  ...
  for (var t = {}, i = true; !this.eat(a.braceR); ) {
    ...
    H(t, r) && this.raiseRecoverable(s.key.start, "Duplicate attribute key '" + r + "'"), t[r] = true, e.push(s);
  }
  return e;
};
...
A.checkLValSimple = function(e, t, i) {
  ...
  switch (e.type) {
    case "Identifier":
      this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (s ? "Binding " : "Assigning to ") + e.name + " in strict mode"), s && (t === O && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), i && (H(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), i[e.name] = true), t !== Ue && this.declareName(e.name, t, e.start));
      break;
    case "ChainExpression":
      this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
      break;
...
}, g = { b_stat: new P("{", false), b_expr: new P("{", true), b_tmpl: new P("${", false), p_stat: new P("(", false), p_expr: new P("(", true), q_tmpl: new P("`", true, true, function(e) {
  return e.tryReadTemplateToken();
}), f_stat: new P("function", false), f_expr: new P("function", true), f_expr_gen: new P("function", true, false, null, true), f_gen: new P("function", false, false, null, true) }, z = b.prototype;
...
z.braceIsBlock = function(e) {
  ...
  return t === g.f_expr || t === g.f_stat ? true : e === a.colon && (t === g.b_stat || t === g.b_expr) ? !t.isExpr : e === a._return || e === a.name && this.exprAllowed ? I.test(this.input.slice(this.lastTokEnd, this.start)) : e === a._else || e === a.semi || e === a.eof || e === a.parenR || e === a.arrow ? true : e === a.braceL ? t === g.b_stat : e === a._var || e === a._const || e === a.name ? false : !this.exprAllowed;
};
...
a.braceL.updateContext = function(e) {
  this.context.push(this.braceIsBlock(e) ? g.b_stat : g.b_expr), this.exprAllowed = true;
};
a.dollarBraceL.updateContext = function() {
  this.context.push(g.b_tmpl), this.exprAllowed = true;
};
a.parenL.updateContext = function(e) {
  var t = e === a._if || e === a._for || e === a._with || e === a._while;
  this.context.push(t ? g.p_stat : g.p_expr), this.exprAllowed = true;
};
a.incDec.updateContext = function() {
};
a._function.updateContext = a._class.updateContext = function(e) {
  e.beforeExpr && e !== a._else && !(e === a.semi && this.curContext() !== g.p_stat) && !(e === a._return && I.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === a.colon || e === a.braceL) && this.curContext() === g.b_stat) ? this.context.push(g.f_expr) : this.context.push(g.f_stat), this.exprAllowed = false;
};
...
a.backQuote.updateContext = function() {
  this.curContext() === g.q_tmpl ? this.context.pop() : this.context.push(g.q_tmpl), this.exprAllowed = false;
};
...
f.parseMaybeAssign = function(e, t, i) {
  ...
  var s = false, r = -1, n = -1, u = -1;
  t ? (r = t.parenthesizedAssign, n = t.trailingComma, u = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new re(), s = true);
  ...
  if (i && (d = i.call(this, d, o, h)), this.type.isAssign) {
    ...
    return p.operator = this.value, this.type === a.eq && (d = this.toAssignable(d, false, t)), s || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= d.start && (t.shorthandAssign = -1), this.type === a.eq ? this.checkLValPattern(d) : this.checkLValSimple(d), p.left = d, this.next(), p.right = this.parseMaybeAssign(e), u > -1 && (t.doubleProto = u), this.finishNode(p, "AssignmentExpression");
...
f.parseExprOp = function(e, t, i, s, r) {
  ...
  if (n != null && (!r || this.type !== a._in) && n > s) {
    ...
    var h = this.value;
    this.next();
    var d = this.start, p = this.startLoc, y = this.parseExprOp(this.parseMaybeUnary(null, false, false, r), d, p, n, r), D = this.buildBinary(t, i, e, y, h, u || o);
...
f.parseMaybeUnary = function(e, t, i, s) {
  ...
  if (this.isContextual("await") && this.canAwait) u = this.parseAwait(s), t = true;
    ...
    o.operator = this.value, o.prefix = true, this.next(), o.argument = this.parseMaybeUnary(null, true, h, s), this.checkExpressionErrors(e, true), h ? this.checkLValSimple(o.argument) : this.strict && o.operator === "delete" && je(o.argument) ? this.raiseRecoverable(o.start, "Deleting local variable in strict mode") : o.operator === "delete" && de(o.argument) ? this.raiseRecoverable(o.start, "Private fields can not be deleted") : t = true, u = this.finishNode(o, h ? "UpdateExpression" : "UnaryExpression");
    ...
    for (; this.type.postfix && !this.canInsertSemicolon(); ) {
      ...
      d.operator = this.value, d.prefix = false, d.argument = u, this.checkLValSimple(u), this.next(), u = this.finishNode(d, "UpdateExpression");
    }
  }
  if (!i && this.eat(a.starstar)) if (t) this.unexpected(this.lastTokStart);
  else return this.buildBinary(r, n, u, this.parseMaybeUnary(null, false, false, s), "**", false);
  else return u;
};
function je(e) {
...
f.parseSubscripts = function(e, t, i, s, r) {
  for (var n = this.options.ecmaVersion >= 8 && e.type === "Identifier" && e.name === "async" && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start === 5 && this.potentialArrowAt === e.start, u = false; ; ) {
    var o = this.parseSubscript(e, t, i, s, n, u, r);
    if (o.optional && (u = true), o === e || o.type === "ArrowFunctionExpression") {
      if (u) {
...
f.parseSubscript = function(e, t, i, s, r, n, u) {
  ...
  if (d || h && this.type !== a.parenL && this.type !== a.backQuote || this.eat(a.dot)) {
    ...
    var y = new re(), D = this.yieldPos, K = this.awaitPos, M = this.awaitIdentPos;
    this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0;
    var $ = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, false, y);
    if (r && !h && this.shouldParseAsyncArrow()) return this.checkPatternErrors(y, false), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = D, this.awaitPos = K, this.awaitIdentPos = M, this.parseSubscriptAsyncArrow(t, i, $, u);
    this.checkExpressionErrors(y, true), this.yieldPos = D || this.yieldPos, this.awaitPos = K || this.awaitPos, this.awaitIdentPos = M || this.awaitIdentPos;
    ...
    q.tag = e, q.quasi = this.parseTemplate({ isTagged: true }), e = this.finishNode(q, "TaggedTemplateExpression");
  }
  return e;
};
f.parseExprAtom = function(e, t, i) {
  ...
  switch (this.type) {
    ...
    case a.name:
      var n = this.start, u = this.startLoc, o = this.containsEsc, h = this.parseIdent(false);
      if (this.options.ecmaVersion >= 8 && !o && h.name === "async" && !this.canInsertSemicolon() && this.eat(a._function)) return this.overrideContext(g.f_expr), this.parseFunction(this.startNodeAt(n, u), 0, false, true, t);
      if (r && !this.canInsertSemicolon()) {
        if (this.eat(a.arrow)) return this.parseArrowExpression(this.startNodeAt(n, u), [h], false, t);
        if (this.options.ecmaVersion >= 8 && h.name === "async" && this.type === a.name && !o && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return h = this.parseIdent(false), (this.canInsertSemicolon() || !this.eat(a.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, u), [h], true, t);
      }
      return h;
    case a.regexp:
      var d = this.value;
    ...
    case a.parenL:
      var p = this.start, y = this.parseParenAndDistinguishExpression(r, t);
    ...
    case a.braceL:
      return this.overrideContext(g.b_expr), this.parseObj(false, e);
    case a._function:
...
f.parseParenAndDistinguishExpression = function(e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    this.next();
    var u = this.start, o = this.startLoc, h = [], d = true, p = false, y = new re(), D = this.yieldPos, K = this.awaitPos, M;
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== a.parenR; ) if (d ? d = false : this.expect(a.comma), n && this.afterTrailingComma(a.parenR, true)) {
      ...
      M = this.start, h.push(this.parseParenItem(this.parseRestBinding())), this.type === a.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
      break;
    } else h.push(this.parseMaybeAssign(false, y, this.parseParenItem));
    var $ = this.lastTokEnd, U = this.lastTokEndLoc;
    if (this.expect(a.parenR), e && this.shouldParseArrow(h) && this.eat(a.arrow)) return this.checkPatternErrors(y, false), this.checkYieldAwaitInDefaultParams(), this.yieldPos = D, this.awaitPos = K, this.parseParenArrowList(i, s, h, t);
    (!h.length || p) && this.unexpected(this.lastTokStart), M && this.unexpected(M), this.checkExpressionErrors(y, true), this.yieldPos = D || this.yieldPos, this.awaitPos = K || this.awaitPos, h.length > 1 ? (r = this.startNodeAt(u, o), r.expressions = h, this.finishNodeAt(r, "SequenceExpression", $, U)) : r = h[0];
...
f.parseNew = function() {
  ...
  return e.callee = this.parseSubscripts(this.parseExprAtom(null, false, true), s, r, true, false), this.eat(a.parenL) ? e.arguments = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, false) : e.arguments = Et, this.finishNode(e, "NewExpression");
};
...
f.parseProperty = function(e, t) {
  ...
  this.options.ecmaVersion >= 6 && (i.method = false, i.shorthand = false, (e || t) && (n = this.start, u = this.startLoc), e || (s = this.eat(a.star)));
  var o = this.containsEsc;
  return this.parsePropertyName(i), !e && !o && this.options.ecmaVersion >= 8 && !s && this.isAsyncProp(i) ? (r = true, s = this.options.ecmaVersion >= 9 && this.eat(a.star), this.parsePropertyName(i)) : r = false, this.parsePropertyValue(i, e, s, r, n, u, t, o), this.finishNode(i, "Property");
};
...
f.parseMethod = function(e, t, i) {
  ...
  return this.initFunction(s), this.options.ecmaVersion >= 6 && (s.generator = e), this.options.ecmaVersion >= 8 && (s.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(be(t, s.generator) | ve | (i ? Fe : 0)), this.expect(a.parenL), s.params = this.parseBindingList(a.parenR, false, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(s, false, true, false), this.yieldPos = r, this.awaitPos = n, this.awaitIdentPos = u, this.finishNode(s, "FunctionExpression");
};
f.parseArrowExpression = function(e, t, i, s) {
  var r = this.yieldPos, n = this.awaitPos, u = this.awaitIdentPos;
  return this.enterScope(be(i, false) | Oe), this.initFunction(e), this.options.ecmaVersion >= 8 && (e.async = !!i), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, e.params = this.toAssignableList(t, true), this.parseFunctionBody(e, true, false, s), this.yieldPos = r, this.awaitPos = n, this.awaitIdentPos = u, this.finishNode(e, "ArrowFunctionExpression");
};
f.parseFunctionBody = function(e, t, i, s) {
  var r = t && this.type !== a.braceL, n = this.strict, u = false;
  if (r) e.body = this.parseMaybeAssign(s), e.expression = true, this.checkParams(e, false);
    ...
    var h = this.labels;
    this.labels = [], u && (this.strict = true), this.checkParams(e, !n && !u && !t && !i && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, Ue), e.body = this.parseBlock(false, void 0, u && !n), e.expression = false, this.adaptDirectivePrologue(e.body.body), this.labels = h;
  }
  this.exitScope();
};
...
ie.curPosition = function() {
  if (this.options.locations) return new Y(this.curLine, this.pos - this.lineStart);
};
var F = b.prototype, It = function(t) {
...
F.treatFunctionsAsVarInScope = function(e) {
  return e.flags & W || !this.inModule && e.flags & X;
};
F.declareName = function(e, t, i) {
  var s = false;
  if (t === O) {
    var r = this.currentScope();
    s = r.lexical.indexOf(e) > -1 || r.functions.indexOf(e) > -1 || r.var.indexOf(e) > -1, r.lexical.push(e), this.inModule && r.flags & X && delete this.undefinedExports[e];
  } else if (t === Me) {
    ...
    if (h.var.push(e), this.inModule && h.flags & X && delete this.undefinedExports[e], h.flags & ge) break;
  }
...
F.currentVarScope = function() {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & ge) return t;
  }
};
F.currentThisScope = function() {
  for (var e = this.scopeStack.length - 1; ; e--) {
    var t = this.scopeStack[e];
    if (t.flags & ge && !(t.flags & Oe)) return t;
  }
};
...
var c = b.prototype, se = function(t, i) {
...
c.validateRegExpFlags = function(e) {
  for (var t = e.validFlags, i = e.flags, s = false, r = false, n = 0; n < i.length; n++) {
    var u = i.charAt(n);
    t.indexOf(u) === -1 && this.raise(e.start, "Invalid regular expression flag"), i.indexOf(u, n + 1) > -1 && this.raise(e.start, "Duplicate regular expression flag"), u === "u" && (s = true), u === "v" && (r = true);
  }
...
c.validateRegExpPattern = function(e) {
  this.regexp_pattern(e), !e.switchN && this.options.ecmaVersion >= 9 && Ft(e.groupNames) && (e.switchN = true, this.regexp_pattern(e));
};
...
c.regexp_disjunction = function(e) {
  ...
  for (t && (e.branchID = new se(e.branchID, null)), this.regexp_alternative(e); e.eat(124); ) t && (e.branchID = e.branchID.sibling()), this.regexp_alternative(e);
...
c.regexp_eatModifiers = function(e) {
  for (var t = "", i = 0; (i = e.current()) !== -1 && Dt(i); ) t += L(i), e.advance();
  return t;
};
function Dt(e) {
...
c.regexp_eatSyntaxCharacter = function(e) {
  var t = e.current();
  return tt(t) ? (e.lastIntValue = t, e.advance(), true) : false;
};
function tt(e) {
  return e === 36 || e >= 40 && e <= 43 || e === 46 || e === 63 || e >= 91 && e <= 94 || e >= 123 && e <= 125;
}
c.regexp_eatPatternCharacters = function(e) {
  for (var t = e.pos, i = 0; (i = e.current()) !== -1 && !tt(i); ) e.advance();
  return e.pos !== t;
};
...
c.regexp_eatRegExpIdentifierStart = function(e) {
  ...
  return e.advance(i), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue), Mt(s) ? (e.lastIntValue = s, true) : (e.pos = t, false);
};
function Mt(e) {
  return T(e, true) || e === 36 || e === 95;
}
c.regexp_eatRegExpIdentifierPart = function(e) {
  var t = e.pos, i = this.options.ecmaVersion >= 11, s = e.current(i);
  return e.advance(i), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue), Ut(s) ? (e.lastIntValue = s, true) : (e.pos = t, false);
};
function Ut(e) {
  return j(e, true) || e === 36 || e === 95 || e === 8204 || e === 8205;
}
...
c.regexp_eatZero = function(e) {
  return e.current() === 48 && !ue(e.lookahead()) ? (e.lastIntValue = 0, e.advance(), true) : false;
};
...
c.regexp_eatControlLetter = function(e) {
  var t = e.current();
  return it(t) ? (e.lastIntValue = t % 32, e.advance(), true) : false;
};
function it(e) {
...
c.regexp_eatRegExpUnicodeEscapeSequence = function(e, t) {
  ...
  if (e.eat(117)) {
    ...
    if (s && e.eat(123) && this.regexp_eatHexDigits(e) && e.eat(125) && qt(e.lastIntValue)) return true;
...
c.regexp_eatCharacterClassEscape = function(e) {
  var t = e.current();
  if (jt(t)) return e.lastIntValue = -1, e.advance(), R;
  var i = false;
  if (e.switchU && this.options.ecmaVersion >= 9 && ((i = t === 80) || t === 112)) {
    e.lastIntValue = -1, e.advance();
    var s;
    if (e.eat(123) && (s = this.regexp_eatUnicodePropertyValueExpression(e)) && e.eat(125)) return i && s === E && e.raise("Invalid property name"), s;
...
c.regexp_validateUnicodePropertyNameOrValue = function(e, t) {
  ...
  if (e.switchV && e.unicodeProperties.binaryOfStrings.test(t)) return E;
  e.raise("Invalid property name");
};
c.regexp_eatUnicodePropertyName = function(e) {
  var t = 0;
  for (e.lastStringValue = ""; at(t = e.current()); ) e.lastStringValue += L(t), e.advance();
...
c.regexp_eatUnicodePropertyValue = function(e) {
  var t = 0;
  for (e.lastStringValue = ""; Gt(t = e.current()); ) e.lastStringValue += L(t), e.advance();
  return e.lastStringValue !== "";
};
function Gt(e) {
  return at(e) || ue(e);
...
c.regexp_eatCharacterClass = function(e) {
  if (e.eat(91)) {
    ...
    return e.eat(93) || e.raise("Unterminated character class"), t && i === E && e.raise("Negated character class may contain strings"), true;
  }
  return false;
};
...
c.regexp_eatNestedClass = function(e) {
  ...
  if (e.eat(91)) {
    ...
    if (e.eat(93)) return i && s === E && e.raise("Negated character class may contain strings"), s;
    e.pos = t;
  }
  if (e.eat(92)) {
...
c.regexp_classStringDisjunctionContents = function(e) {
  for (var t = this.regexp_classString(e); e.eat(124); ) this.regexp_classString(e) === E && (t = E);
  return t;
};
...
c.regexp_eatClassSetCharacter = function(e) {
  ...
  var i = e.current();
  return i < 0 || i === e.lookahead() && Ht(i) || Wt(i) ? false : (e.advance(), e.lastIntValue = i, true);
};
function Ht(e) {
...
c.regexp_eatClassSetReservedPunctuator = function(e) {
  var t = e.current();
  return zt(t) ? (e.lastIntValue = t, e.advance(), true) : false;
};
function zt(e) {
...
c.regexp_eatClassControlLetter = function(e) {
  var t = e.current();
  return ue(t) || t === 95 ? (e.lastIntValue = t % 32, e.advance(), true) : false;
};
...
c.regexp_eatDecimalDigits = function(e) {
  var t = e.pos, i = 0;
  for (e.lastIntValue = 0; ue(i = e.current()); ) e.lastIntValue = 10 * e.lastIntValue + (i - 48), e.advance();
  return e.pos !== t;
};
function ue(e) {
  return e >= 48 && e <= 57;
...
c.regexp_eatHexDigits = function(e) {
  var t = e.pos, i = 0;
  for (e.lastIntValue = 0; rt(i = e.current()); ) e.lastIntValue = 16 * e.lastIntValue + nt(i), e.advance();
  return e.pos !== t;
};
function rt(e) {
...
c.regexp_eatOctalDigit = function(e) {
  var t = e.current();
  return ut(t) ? (e.lastIntValue = t - 48, e.advance(), true) : (e.lastIntValue = 0, false);
};
function ut(e) {
  return e >= 48 && e <= 55;
}
...
x.skipBlockComment = function() {
  ...
  if (i === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = i + 2, this.options.locations) for (var s = void 0, r = t; (s = Ne(this.input, r, this.pos)) > -1; ) ++this.curLine, r = this.lineStart = s;
...
x.skipLineComment = function(e) {
  for (var t = this.pos, i = this.options.onComment && this.curPosition(), s = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !G(s); ) s = this.input.charCodeAt(++this.pos);
...
x.readToken_numberSign = function() {
  ...
  if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), T(t, true) || t === 92)) return this.finishToken(a.privateId, this.readWord1());
...
x.readRegexp = function() {
  for (var e, t, i = this.pos; ; ) {
    ...
    if (I.test(s) && this.raise(i, "Unterminated regular expression"), e) e = false;
    else {
      if (s === "[") t = true;
      else if (s === "]" && t) t = false;
      else if (s === "/" && !t) break;
...
x.readInt = function(e, t, i) {
  for (var s = this.options.ecmaVersion >= 12 && t === void 0, r = i && this.input.charCodeAt(this.pos) === 48, n = this.pos, u = 0, o = 0, h = 0, d = t ?? 1 / 0; h < d; ++h, ++this.pos) {
    var p = this.input.charCodeAt(this.pos), y = void 0;
    if (s && p === 95) {
    ...
    if (p >= 97 ? y = p - 97 + 10 : p >= 65 ? y = p - 65 + 10 : p >= 48 && p <= 57 ? y = p - 48 : y = 1 / 0, y >= e) break;
    o = p, u = u * e + y;
  }
...
x.readRadixNumber = function(e) {
  ...
  return i == null && this.raise(this.start + 2, "Expected number in radix " + e), this.options.ecmaVersion >= 11 && this.input.charCodeAt(this.pos) === 110 ? (i = ot(this.input.slice(t, this.pos)), ++this.pos) : T(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number"), this.finishToken(a.num, i);
};
x.readNumber = function(e) {
  ...
  i && /[89]/.test(this.input.slice(t, this.pos)) && (i = false), s === 46 && !i && (++this.pos, this.readInt(10), s = this.input.charCodeAt(this.pos)), (s === 69 || s === 101) && !i && (s = this.input.charCodeAt(++this.pos), (s === 43 || s === 45) && ++this.pos, this.readInt(10) === null && this.raise(t, "Invalid number")), T(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
  var n = Kt(this.input.slice(t, this.pos), i);
...
x.readString = function(e) {
  for (var t = "", i = ++this.pos; ; ) {
    ...
    var s = this.input.charCodeAt(this.pos);
    if (s === e) break;
    s === 92 ? (t += this.input.slice(i, this.pos), t += this.readEscapedChar(false), i = this.pos) : s === 8232 || s === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (G(s) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
  }
...
x.tryReadTemplateToken = function() {
  ...
  try {
    ...
    if (e === ht) this.readInvalidTemplateToken();
    else throw e;
  }
...
x.readWord1 = function() {
  ...
  for (var e = "", t = true, i = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
    ...
    if (j(r, s)) this.pos += r <= 65535 ? 1 : 2;
    else if (r === 92) {
      this.containsEsc = true, e += this.input.slice(i, this.pos);
      var n = this.pos;
      this.input.charCodeAt(++this.pos) !== 117 && this.invalidStringToken(this.pos, "Expecting Unicode escape sequence \\uXXXX"), ++this.pos;
      var u = this.readCodePoint();
      (t ? T : j)(u, s) || this.invalidStringToken(n, "Invalid Unicode escape"), e += L(u), i = this.pos;
    } else break;
    t = false;
  }
...
var Qt = "8.14.0";
b.acorn = { Parser: b, version: Qt, defaultOptions: pe, Position: Y, SourceLocation: ae, getLineInfo: Le, Node: ne, TokenType: v, tokTypes: a, keywordTypes: xe, TokContext: P, tokContexts: g, isIdentifierChar: j, isIdentifierStart: T, Token: Ce, isNewLine: G, lineBreak: I, lineBreakG: mt, nonASCIIwhitespace: Ve };
function Yt(e, t) {
  return b.parse(e, t);
}
function Xt(e, t, i) {
