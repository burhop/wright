...
import { m as Xe } from "./vendor-CRPgzvoS.js";
/*!-----------------------------------------------------------------------------
...
var Be = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, qe = Object.getOwnPropertyNames, Qe = Object.prototype.hasOwnProperty, Ge = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function") for (let t of qe(n)) !Qe.call(e, t) && t !== i && Be(e, t, { get: () => n[t], enumerable: !(r = $e(n, t)) || r.enumerable });
  return e;
}, Je = (e, n, i) => (Ge(e, n, "default"), i), c = {};
Je(c, Xe);
var Ye = 120 * 1e3, Re = class {
  constructor(e) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = c.editor.createWebWorker({ moduleId: "vs/language/html/htmlWorker", createData: { languageSettings: this._defaults.options, languageId: this._defaults.languageId }, label: this._defaults.languageId }), this._client = this._worker.getProxy()), this._client;
  }
...
(function(e) {
  function n(r, t, a, o) {
    if (s.uinteger(r) && s.uinteger(t) && s.uinteger(a) && s.uinteger(o)) return { start: k.create(r, t), end: k.create(a, o) };
...
var N = (function() {
  ...
  return e.prototype.insert = function(n, i, r) {
    var t, a;
    if (r === void 0 ? t = x.insert(n, i) : m.is(r) ? (a = r, t = E.insert(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), t = E.insert(n, i, a)), this.edits.push(t), a !== void 0) return a;
  }, e.prototype.replace = function(n, i, r) {
    var t, a;
    if (r === void 0 ? t = x.replace(n, i) : m.is(r) ? (a = r, t = E.replace(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), t = E.replace(n, i, a)), this.edits.push(t), a !== void 0) return a;
  }, e.prototype.delete = function(n, i) {
    var r, t;
    if (i === void 0 ? r = x.del(n) : m.is(i) ? (t = i, r = E.del(n, i)) : (this.assertChangeAnnotations(this.changeAnnotations), t = this.changeAnnotations.manage(i), r = E.del(n, t)), this.edits.push(r), t !== void 0) return t;
...
(function() {
  ...
  return Object.defineProperty(e.prototype, "edit", { get: function() {
    ...
    var a, o;
    if (t === void 0 ? a = M.create(n, r) : (o = m.is(t) ? t : this._changeAnnotations.manage(t), a = M.create(n, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0) return o;
  }, e.prototype.renameFile = function(n, i, r, t) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
    var a;
    I.is(r) || m.is(r) ? a = r : t = r;
    var o, u;
    if (a === void 0 ? o = S.create(n, i, t) : (u = m.is(a) ? a : this._changeAnnotations.manage(a), o = S.create(n, i, t, u)), this._workspaceEdit.documentChanges.push(o), u !== void 0) return u;
  }, e.prototype.deleteFile = function(n, i, r) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
    var t;
    I.is(i) || m.is(i) ? t = i : r = i;
    var a, o;
    if (t === void 0 ? a = T.create(n, r) : (o = m.is(t) ? t : this._changeAnnotations.manage(t), a = T.create(n, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0) return o;
  }, e;
})();
var ie;
(function(e) {
...
(function(e) {
  function n(r, t, a) {
    ...
    return typeof t == "string" ? (u = false, o.kind = t) : D.is(t) ? o.command = t : o.edit = t, u && a !== void 0 && (o.kind = a), o;
  }
  e.create = n;
  function i(r) {
    var t = r;
...
(function(e) {
  ...
  function r(a, o) {
    for (var u = a.getText(), f = t(o, function(A, j) {
      ...
      if (g <= d) u = u.substring(0, b) + w.newText + u.substring(g, u.length);
...
function et(e, n) {
  ...
  return { severity: Ke(n.severity), startLineNumber: n.range.start.line + 1, startColumn: n.range.start.character + 1, endLineNumber: n.range.end.line + 1, endColumn: n.range.end.character + 1, message: n.message, code: i, source: n.source };
}
var tt = class {
  constructor(e, n) {
  ...
  provideCompletionItems(e, n, i, r) {
    ...
    return this._worker(t).then((a) => a.doComplete(t.toString(), C(n))).then((a) => {
      ...
      const o = e.getWordUntilPosition(n), u = new c.Range(n.lineNumber, o.startColumn, n.lineNumber, o.endColumn), f = a.items.map((d) => {
        const v = { label: d.label, insertText: d.insertText || d.label, sortText: d.sortText, filterText: d.filterText, documentation: d.documentation, detail: d.detail, command: it(d.command), range: u, kind: nt(d.kind) };
        return d.textEdit && (rt(d.textEdit) ? v.range = { insert: _(d.textEdit.insert), replace: _(d.textEdit.replace) } : v.range = _(d.textEdit.range), v.insertText = d.textEdit.newText), d.additionalTextEdits && (v.additionalTextEdits = d.additionalTextEdits.map(L)), d.insertTextFormat === Q.Snippet && (v.insertTextRules = c.languages.CompletionItemInsertTextRule.InsertAsSnippet), v;
      });
...
var Me = class {
  ...
  provideHover(e, n, i) {
    ...
    return this._worker(r).then((t) => t.doHover(r.toString(), C(n))).then((t) => {
      if (t) return { range: _(t.range), contents: ot(t.contents) };
    });
  }
};
function at(e) {
...
function Ie(e) {
  return typeof e == "string" ? { value: e } : at(e) ? e.kind === "plaintext" ? { value: e.value.replace(/[\\`*_{}[\]()#+\-.!]/g, "\\$&") } : { value: e.value } : { value: "```" + e.language + `
` + e.value + "\n```\n" };
}
function ot(e) {
  if (e) return Array.isArray(e) ? e.map(Ie) : [Ie(e)];
}
var Se = class {
  constructor(e) {
    this._worker = e;
  ...
  provideDocumentHighlights(e, n, i) {
    ...
    return this._worker(r).then((t) => t.findDocumentHighlights(r.toString(), C(n))).then((t) => {
      if (t) return t.map((a) => ({ range: _(a.range), kind: st(a.kind) }));
    });
  }
};
function st(e) {
...
function ut(e) {
  ...
  for (let i in e.changes) {
    ...
    for (let t of e.changes[i]) n.push({ resource: r, versionId: void 0, textEdit: { range: _(t.range), text: t.newText } });
  }
  return { edits: n };
}
var Le = class {
  ...
  provideDocumentSymbols(e, n) {
    ...
    return this._worker(i).then((r) => r.findDocumentSymbols(i.toString())).then((r) => {
      if (r) return r.map((t) => ({ name: t.name, detail: "", containerName: t.containerName, kind: ct(t.kind), range: _(t.location.range), selectionRange: _(t.location.range), tags: [] }));
    });
  }
};
function ct(e) {
