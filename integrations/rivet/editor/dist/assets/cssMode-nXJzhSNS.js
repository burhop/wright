...
import { m as Se } from "./vendor-CRPgzvoS.js";
/*!-----------------------------------------------------------------------------
...
var Fe = Object.defineProperty, Le = Object.getOwnPropertyDescriptor, je = Object.getOwnPropertyNames, Ne = Object.prototype.hasOwnProperty, We = (t, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function") for (let e of je(n)) !Ne.call(t, e) && e !== i && Fe(t, e, { get: () => n[e], enumerable: !(r = Le(n, e)) || r.enumerable });
  return t;
}, Ue = (t, n, i) => (We(t, n, "default"), i), c = {};
Ue(c, Se);
var Oe = 120 * 1e3, Ve = class {
  constructor(t) {
  ...
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = c.editor.createWebWorker({ moduleId: "vs/language/css/cssWorker", label: this._defaults.languageId, createData: { options: this._defaults.options, languageId: this._defaults.languageId } }), this._client = this._worker.getProxy()), this._client;
  }
...
(function(t) {
  function n(r, e, a, o) {
    if (s.uinteger(r) && s.uinteger(e) && s.uinteger(a) && s.uinteger(o)) return { start: k.create(r, e), end: k.create(a, o) };
    if (k.is(r) && k.is(e)) return { start: r, end: e };
...
var N = (function() {
  ...
  return t.prototype.insert = function(n, i, r) {
    var e, a;
    if (r === void 0 ? e = x.insert(n, i) : m.is(r) ? (a = r, e = E.insert(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), e = E.insert(n, i, a)), this.edits.push(e), a !== void 0) return a;
  }, t.prototype.replace = function(n, i, r) {
    var e, a;
    if (r === void 0 ? e = x.replace(n, i) : m.is(r) ? (a = r, e = E.replace(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), e = E.replace(n, i, a)), this.edits.push(e), a !== void 0) return a;
  }, t.prototype.delete = function(n, i) {
    var r, e;
    if (i === void 0 ? r = x.del(n) : m.is(i) ? (e = i, r = E.del(n, i)) : (this.assertChangeAnnotations(this.changeAnnotations), e = this.changeAnnotations.manage(i), r = E.del(n, e)), this.edits.push(r), e !== void 0) return e;
  ...
  return t.prototype.all = function() {
    ...
    return this._size;
  }, enumerable: false, configurable: true }), t.prototype.manage = function(n, i) {
    var r;
    if (m.is(n) ? r = n : (r = this.nextId(), i = n), this._annotations[r] !== void 0) throw new Error("Id " + r + " is already in use.");
...
(function() {
  ...
  return Object.defineProperty(t.prototype, "edit", { get: function() {
  ...
  }, enumerable: false, configurable: true }), t.prototype.getTextEditChange = function(n) {
    if (V.is(n)) {
      ...
      if (!r) {
        var e = [], a = { textDocument: i, edits: e };
    ...
    var a, o;
    if (e === void 0 ? a = M.create(n, r) : (o = m.is(e) ? e : this._changeAnnotations.manage(e), a = M.create(n, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0) return o;
  }, t.prototype.renameFile = function(n, i, r, e) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
    var a;
    I.is(r) || m.is(r) ? a = r : e = r;
    var o, u;
    if (a === void 0 ? o = T.create(n, i, e) : (u = m.is(a) ? a : this._changeAnnotations.manage(a), o = T.create(n, i, e, u)), this._workspaceEdit.documentChanges.push(o), u !== void 0) return u;
  }, t.prototype.deleteFile = function(n, i, r) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
    var e;
    I.is(i) || m.is(i) ? e = i : r = i;
    var a, o;
    if (e === void 0 ? a = S.create(n, r) : (o = m.is(e) ? e : this._changeAnnotations.manage(e), a = S.create(n, r, o)), this._workspaceEdit.documentChanges.push(a), o !== void 0) return o;
  }, t;
})();
var ie;
(function(t) {
...
(function(t) {
  function n(r, e, a) {
    ...
    return typeof e == "string" ? (u = false, o.kind = e) : D.is(e) ? o.command = e : o.edit = e, u && a !== void 0 && (o.kind = a), o;
  }
  t.create = n;
  function i(r) {
    var e = r;
...
(function(t) {
  ...
  function r(a, o) {
    for (var u = a.getText(), g = e(o, function(A, j) {
      ...
      if (f <= d) u = u.substring(0, b) + w.newText + u.substring(f, u.length);
  ...
  function e(a, o) {
    ...
    for (; v < g.length; ) a[b++] = g[v++];
    for (; w < d.length; ) a[b++] = d[w++];
    return a;
  }
})(ye || (ye = {}));
var He = (function() {
  ...
  return Object.defineProperty(t.prototype, "uri", { get: function() {
    return this._uri;
  }, enumerable: false, configurable: true }), Object.defineProperty(t.prototype, "languageId", { get: function() {
    return this._languageId;
  }, enumerable: false, configurable: true }), Object.defineProperty(t.prototype, "version", { get: function() {
    return this._version;
  }, enumerable: false, configurable: true }), t.prototype.getText = function(n) {
    if (n) {
    ...
    if (this._lineOffsets === void 0) {
      for (var n = [], i = this._content, r = true, e = 0; e < i.length; e++) {
        r && (n.push(e), r = false);
        var a = i.charAt(e);
        r = a === "\r" || a === `
...
` && e++;
  ...
  }, Object.defineProperty(t.prototype, "lineCount", { get: function() {
...
function Be(t, n) {
  ...
  return { severity: Xe(n.severity), startLineNumber: n.range.start.line + 1, startColumn: n.range.start.character + 1, endLineNumber: n.range.end.line + 1, endColumn: n.range.end.character + 1, message: n.message, code: i, source: n.source };
}
var $e = class {
  constructor(t, n) {
  ...
  provideCompletionItems(t, n, i, r) {
    ...
    return this._worker(e).then((a) => a.doComplete(e.toString(), C(n))).then((a) => {
      ...
      const o = t.getWordUntilPosition(n), u = new c.Range(n.lineNumber, o.startColumn, n.lineNumber, o.endColumn), g = a.items.map((d) => {
        const v = { label: d.label, insertText: d.insertText || d.label, sortText: d.sortText, filterText: d.filterText, documentation: d.documentation, detail: d.detail, command: Ge(d.command), range: u, kind: Qe(d.kind) };
        return d.textEdit && (qe(d.textEdit) ? v.range = { insert: _(d.textEdit.insert), replace: _(d.textEdit.replace) } : v.range = _(d.textEdit.range), v.insertText = d.textEdit.newText), d.additionalTextEdits && (v.additionalTextEdits = d.additionalTextEdits.map(L)), d.insertTextFormat === Q.Snippet && (v.insertTextRules = c.languages.CompletionItemInsertTextRule.InsertAsSnippet), v;
      });
...
function Pe(t) {
  if (t) return { start: { line: t.startLineNumber - 1, character: t.startColumn - 1 }, end: { line: t.endLineNumber - 1, character: t.endColumn - 1 } };
}
function _(t) {
...
var Je = class {
  ...
  provideHover(t, n, i) {
    ...
    return this._worker(r).then((e) => e.doHover(r.toString(), C(n))).then((e) => {
      if (e) return { range: _(e.range), contents: Ze(e.contents) };
    });
  }
};
function Ye(t) {
...
function Ie(t) {
  return typeof t == "string" ? { value: t } : Ye(t) ? t.kind === "plaintext" ? { value: t.value.replace(/[\\`*_{}[\]()#+\-.!]/g, "\\$&") } : { value: t.value } : { value: "```" + t.language + `
` + t.value + "\n```\n" };
}
function Ze(t) {
  if (t) return Array.isArray(t) ? t.map(Ie) : [Ie(t)];
}
var Ke = class {
  constructor(t) {
    this._worker = t;
  ...
  provideDocumentHighlights(t, n, i) {
    ...
    return this._worker(r).then((e) => e.findDocumentHighlights(r.toString(), C(n))).then((e) => {
      if (e) return e.map((a) => ({ range: _(a.range), kind: et(a.kind) }));
    });
  }
};
function et(t) {
...
function it(t) {
  ...
  for (let i in t.changes) {
    ...
    for (let e of t.changes[i]) n.push({ resource: r, versionId: void 0, textEdit: { range: _(e.range), text: e.newText } });
  }
  return { edits: n };
}
var at = class {
  ...
  provideDocumentSymbols(t, n) {
    ...
    return this._worker(i).then((r) => r.findDocumentSymbols(i.toString())).then((r) => {
      if (r) return r.map((e) => ({ name: e.name, detail: "", containerName: e.containerName, kind: ot(e.kind), range: _(e.location.range), selectionRange: _(e.location.range), tags: [] }));
    });
  }
};
function ot(t) {
...
var ht = class {
  ...
  provideDocumentFormattingEdits(t, n, i) {
    ...
    return this._worker(r).then((e) => e.format(r.toString(), null, Me(n)).then((a) => {
      if (!(!a || a.length === 0)) return a.map(L);
    }));
  }
}, ut = class {
  constructor(t) {
