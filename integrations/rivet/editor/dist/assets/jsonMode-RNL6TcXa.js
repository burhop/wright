...
import { m as Ye } from "./vendor-Bw7vnkIi.js";
/*!-----------------------------------------------------------------------------
...
var $e = Object.defineProperty, Ge = Object.getOwnPropertyDescriptor, Qe = Object.getOwnPropertyNames, Ze = Object.prototype.hasOwnProperty, Ke = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function") for (let t of Qe(n)) !Ze.call(e, t) && t !== i && $e(e, t, { get: () => n[t], enumerable: !(r = Ge(n, t)) || r.enumerable });
  return e;
}, et = (e, n, i) => (Ke(e, n, "default"), i), l = {};
et(l, Ye);
var tt = 120 * 1e3, rt = class {
  constructor(e) {
...
(function(e) {
  function n(r, t, a, s) {
    if (o.uinteger(r) && o.uinteger(t) && o.uinteger(a) && o.uinteger(s)) return { start: I.create(r, t), end: I.create(a, s) };
...
var X = (function() {
  ...
  return e.prototype.insert = function(n, i, r) {
    var t, a;
    if (r === void 0 ? t = P.insert(n, i) : w.is(r) ? (a = r, t = T.insert(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), t = T.insert(n, i, a)), this.edits.push(t), a !== void 0) return a;
  }, e.prototype.replace = function(n, i, r) {
    var t, a;
    if (r === void 0 ? t = P.replace(n, i) : w.is(r) ? (a = r, t = T.replace(n, i, r)) : (this.assertChangeAnnotations(this.changeAnnotations), a = this.changeAnnotations.manage(r), t = T.replace(n, i, a)), this.edits.push(t), a !== void 0) return a;
  }, e.prototype.delete = function(n, i) {
    var r, t;
    if (i === void 0 ? r = P.del(n) : w.is(i) ? (t = i, r = T.del(n, i)) : (this.assertChangeAnnotations(this.changeAnnotations), t = this.changeAnnotations.manage(i), r = T.del(n, t)), this.edits.push(r), t !== void 0) return t;
  ...
  return e.prototype.all = function() {
    ...
    return this._size;
  }, enumerable: false, configurable: true }), e.prototype.manage = function(n, i) {
    var r;
    if (w.is(n) ? r = n : (r = this.nextId(), i = n), this._annotations[r] !== void 0) throw new Error("Id " + r + " is already in use.");
...
(function() {
  ...
  return Object.defineProperty(e.prototype, "edit", { get: function() {
  ...
  }, enumerable: false, configurable: true }), e.prototype.getTextEditChange = function(n) {
    if (G.is(n)) {
      ...
      if (!r) {
        var t = [], a = { textDocument: i, edits: t };
    ...
    var a, s;
    if (t === void 0 ? a = V.create(n, r) : (s = w.is(t) ? t : this._changeAnnotations.manage(t), a = V.create(n, r, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0) return s;
  }, e.prototype.renameFile = function(n, i, r, t) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
    var a;
    O.is(r) || w.is(r) ? a = r : t = r;
    var s, u;
    if (a === void 0 ? s = H.create(n, i, t) : (u = w.is(a) ? a : this._changeAnnotations.manage(a), s = H.create(n, i, t, u)), this._workspaceEdit.documentChanges.push(s), u !== void 0) return u;
  }, e.prototype.deleteFile = function(n, i, r) {
    if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0) throw new Error("Workspace edit is not configured for document changes.");
    var t;
    O.is(i) || w.is(i) ? t = i : r = i;
    var a, s;
    if (t === void 0 ? a = z.create(n, r) : (s = w.is(t) ? t : this._changeAnnotations.manage(t), a = z.create(n, r, s)), this._workspaceEdit.documentChanges.push(a), s !== void 0) return s;
  }, e;
})();
var he;
(function(e) {
...
(function(e) {
  function n(r, t, a) {
    var s = { title: r }, u = true;
    return typeof t == "string" ? (u = false, s.kind = t) : U.is(t) ? s.command = t : s.edit = t, u && a !== void 0 && (s.kind = a), s;
  }
  e.create = n;
  function i(r) {
    var t = r;
...
(function(e) {
  ...
  function r(a, s) {
    for (var u = a.getText(), c = t(s, function(S, L) {
      ...
      if (h <= d) u = u.substring(0, b) + g.newText + u.substring(h, u.length);
  ...
  function t(a, s) {
    ...
    for (; v < c.length; ) a[b++] = c[v++];
    for (; g < d.length; ) a[b++] = d[g++];
    return a;
  }
})(xe || (xe = {}));
var nt = (function() {
  ...
  return Object.defineProperty(e.prototype, "uri", { get: function() {
    return this._uri;
  }, enumerable: false, configurable: true }), Object.defineProperty(e.prototype, "languageId", { get: function() {
    return this._languageId;
  }, enumerable: false, configurable: true }), Object.defineProperty(e.prototype, "version", { get: function() {
    return this._version;
  }, enumerable: false, configurable: true }), e.prototype.getText = function(n) {
    if (n) {
...
function st(e, n) {
  ...
  return { severity: at(n.severity), startLineNumber: n.range.start.line + 1, startColumn: n.range.start.character + 1, endLineNumber: n.range.end.line + 1, endColumn: n.range.end.character + 1, message: n.message, code: i, source: n.source };
}
var ot = class {
  constructor(e, n) {
  ...
  provideCompletionItems(e, n, i, r) {
    ...
    return this._worker(t).then((a) => a.doComplete(t.toString(), M(n))).then((a) => {
      ...
      const s = e.getWordUntilPosition(n), u = new l.Range(n.lineNumber, s.startColumn, n.lineNumber, s.endColumn), c = a.items.map((d) => {
        const v = { label: d.label, insertText: d.insertText || d.label, sortText: d.sortText, filterText: d.filterText, documentation: d.documentation, detail: d.detail, command: dt(d.command), range: u, kind: ct(d.kind) };
        return d.textEdit && (ut(d.textEdit) ? v.range = { insert: E(d.textEdit.insert), replace: E(d.textEdit.replace) } : v.range = E(d.textEdit.range), v.insertText = d.textEdit.newText), d.additionalTextEdits && (v.additionalTextEdits = d.additionalTextEdits.map(q)), d.insertTextFormat === ae.Snippet && (v.insertTextRules = l.languages.CompletionItemInsertTextRule.InsertAsSnippet), v;
      });
...
function q(e) {
  if (e) return { range: E(e.range), text: e.newText };
}
function dt(e) {
...
var ft = class {
  ...
  provideHover(e, n, i) {
    ...
    return this._worker(r).then((t) => t.doHover(r.toString(), M(n))).then((t) => {
      if (t) return { range: E(t.range), contents: gt(t.contents) };
    });
  }
};
function lt(e) {
...
function je(e) {
  return typeof e == "string" ? { value: e } : lt(e) ? e.kind === "plaintext" ? { value: e.value.replace(/[\\`*_{}[\]()#+\-.!]/g, "\\$&") } : { value: e.value } : { value: "```" + e.language + `
` + e.value + "\n```\n" };
}
function gt(e) {
...
var Ut = class {
  ...
  provideDocumentHighlights(e, n, i) {
    ...
    return this._worker(r).then((t) => t.findDocumentHighlights(r.toString(), M(n))).then((t) => {
      if (t) return t.map((a) => ({ range: E(a.range), kind: ht(a.kind) }));
    });
  }
};
function ht(e) {
...
function ze(e) {
  return { uri: l.Uri.parse(e.uri), range: E(e.range) };
}
var Ht = class {
  constructor(e) {
    this._worker = e;
...
function vt(e) {
  ...
  for (let i in e.changes) {
    ...
    for (let t of e.changes[i]) n.push({ resource: r, versionId: void 0, textEdit: { range: E(t.range), text: t.newText } });
  }
  return { edits: n };
}
var pt = class {
  ...
  provideDocumentSymbols(e, n) {
    ...
    return this._worker(i).then((r) => r.findDocumentSymbols(i.toString())).then((r) => {
      if (r) return r.map((t) => ({ name: t.name, detail: "", containerName: t.containerName, kind: mt(t.kind), range: E(t.location.range), selectionRange: E(t.location.range), tags: [] }));
    });
  }
};
function mt(e) {
...
var Bt = class {
  ...
  provideLinks(e, n) {
    ...
    return this._worker(i).then((r) => r.findDocumentLinks(i.toString())).then((r) => {
      if (r) return { links: r.map((t) => ({ range: E(t.range), url: t.target })) };
    });
  }
}, _t = class {
  constructor(e) {
  ...
  provideDocumentFormattingEdits(e, n, i) {
    ...
    return this._worker(r).then((t) => t.format(r.toString(), null, Be(n)).then((a) => {
      if (!(!a || a.length === 0)) return a.map(q);
    }));
  }
}, kt = class {
  constructor(e) {
  ...
  provideDocumentRangeFormattingEdits(e, n, i, r) {
    ...
    return this._worker(t).then((a) => a.format(t.toString(), He(n), Be(i)).then((s) => {
      if (!(!s || s.length === 0)) return s.map(q);
    }));
  }
};
function Be(e) {
...
var wt = class {
  ...
  provideDocumentColors(e, n) {
    ...
    return this._worker(i).then((r) => r.findDocumentColors(i.toString())).then((r) => {
      if (r) return r.map((t) => ({ color: t.color, range: E(t.range) }));
    });
  }
...
var Et = class {
  ...
  provideSelectionRanges(e, n, i) {
    ...
    return this._worker(r).then((t) => t.getSelectionRanges(r.toString(), n.map(M))).then((t) => {
      if (t) return t.map((a) => {
        const s = [];
        for (; a; ) s.push({ range: E(a.range) }), a = a.parent;
        return s;
      });
    });
  }
...
function At(e, n) {
  ...
  function b(f, A) {
    for (var y = 0, C = 0; y < f; ) {
      ...
      if (k >= 48 && k <= 57) C = C * 16 + k - 48;
      else if (k >= 65 && k <= 70) C = C * 16 + k - 65 + 10;
      else if (k >= 97 && k <= 102) C = C * 16 + k - 97 + 10;
      else break;
      r++, y++;
    }
    return y < f && (C = -1), C;
  ...
  function S() {
    ...
    else for (r++; r < e.length && R(e.charCodeAt(r)); ) r++;
    if (r < e.length && e.charCodeAt(r) === 46) if (r++, r < e.length && R(e.charCodeAt(r))) for (r++; r < e.length && R(e.charCodeAt(r)); ) r++;
    else return g = 3, e.substring(f, r);
    var A = r;
    if (r < e.length && (e.charCodeAt(r) === 69 || e.charCodeAt(r) === 101)) if (r++, (r < e.length && e.charCodeAt(r) === 43 || e.charCodeAt(r) === 45) && r++, r < e.length && R(e.charCodeAt(r))) {
      for (r++; r < e.length && R(e.charCodeAt(r)); ) r++;
      A = r;
    } else g = 3;
    return e.substring(f, A);
  }
  function L() {
    for (var f = "", A = r; ; ) {
      if (r >= i) {
        f += e.substring(A, r), g = 2;
        break;
      }
...
`;
  ...
  function x() {
    ...
    if (j(f)) return r++, t += String.fromCharCode(f), f === 13 && e.charCodeAt(r) === 10 && (r++, t += `
`), u++, d = r, s = 14;
    switch (f) {
      case 123:
        return r++, s = 1;
      ...
      case 47:
        ...
        if (e.charCodeAt(r + 1) === 47) {
          for (r += 2; r < i && !j(e.charCodeAt(r)); ) r++;
          return t = e.substring(A, r), s = 12;
        }
        if (e.charCodeAt(r + 1) === 42) {
          r += 2;
          for (var y = i - 1, C = false; r < y; ) {
            var k = e.charCodeAt(r);
          ...
          return C || (r++, g = 1), t = e.substring(A, r), s = 13;
        }
        return t += String.fromCharCode(f), r++, s = 16;
      case 45:
        if (t += String.fromCharCode(f), r++, r === i || !R(e.charCodeAt(r))) return s = 16;
      case 48:
      case 49:
      case 50:
      case 51:
      ...
      case 57:
        return t += S(), s = 11;
      default:
        for (; r < i && Xe(f); ) r++, f = e.charCodeAt(r);
        if (a !== r) {
  ...
  return { setPosition: h, getPosition: function() {
    return r;
  }, scan: n ? Je : x, getToken: function() {
    return s;
...
var yt = At;
function St(e) {
  return { getInitialState: () => new Z(null, null, false, null), tokenize: (n, i) => xt(e, n, i) };
}
var We = "delimiter.bracket.json", Ue = "delimiter.array.json", It = "delimiter.colon.json", Tt = "delimiter.comma.json", Pt = "keyword.json", Mt = "keyword.json", Lt = "string.value.json", Rt = "number.json", Dt = "string.key.json", Nt = "comment.block.json", Ot = "comment.line.json", N = class {
  ...
  equals(e) {
    return e === this ? true : !e || !(e instanceof Z) ? false : this.scanError === e.scanError && this.lastWasColon === e.lastWasColon && N.equals(this.parents, e.parents);
  }
  getStateData() {
    return this._state;
  }
...
function xt(e, n, i, r = 0) {
  ...
  for (; ; ) {
    ...
    const b = s.scan();
    if (b === 17) break;
    if (v === r + s.getPosition()) throw new Error("Scanner did not advance, next 3 characters are: " + n.substr(s.getPosition(), 3));
    switch (a && (v -= t), a = t > 0, b) {
      case 1:
        c = N.push(c, 0), g = We, u = false;
        break;
      case 2:
        c = N.pop(c), g = We, u = false;
        break;
      case 3:
        c = N.push(c, 1), g = Ue, u = false;
        break;
      case 4:
        c = N.pop(c), g = Ue, u = false;
        break;
      case 6:
        g = It, u = true;
        break;
    ...
    d.endState = new Z(i.getStateData(), s.getTokenError(), u, c), d.tokens.push({ startIndex: v, scopes: g });
  }
  return d;
}
...
var Ft = { wordPattern: /(-?\d*\.\d\w*)|([^\[\{\]\}\:\"\,\s]+)/g, comments: { lineComment: "//", blockComment: ["/*", "*/"] }, brackets: [["{", "}"], ["[", "]"]], autoClosingPairs: [{ open: "{", close: "}", notIn: ["string"] }, { open: "[", close: "]", notIn: ["string"] }, { open: '"', close: '"', notIn: ["string"] }] };
export {
