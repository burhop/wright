...
import { t as O, m as I } from "./vendor-Bw7vnkIi.js";
/*!-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------*/
var A = Object.defineProperty, N = Object.getOwnPropertyDescriptor, M = Object.getOwnPropertyNames, R = Object.prototype.hasOwnProperty, K = (e, t, s) => t in e ? A(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s, E = (e, t, s, o) => {
  if (t && typeof t == "object" || typeof t == "function") for (let i of M(t)) !R.call(e, i) && i !== s && A(e, i, { get: () => t[i], enumerable: !(o = N(t, i)) || o.enumerable });
  return e;
...
var V = class {
  ...
  _getClient() {
    return this._client || (this._client = (async () => (this._worker = a.editor.createWebWorker({ moduleId: "vs/language/typescript/tsWorker", label: this._modeId, keepIdleModels: true, createData: { compilerOptions: this._defaults.getCompilerOptions(), extraLibs: this._defaults.getExtraLibs(), customWorkerPath: this._defaults.workerOptions.customWorkerPath, inlayHintsOptions: this._defaults.inlayHintsOptions } }), this._defaults.getEagerModelSync() ? await this._worker.withSyncedResources(a.editor.getModels().filter((e) => e.getLanguageId() === this._modeId).map((e) => e.uri)) : await this._worker.getProxy()))()), this._client;
  }
...
n["lib.d.ts"] = true;
n["lib.decorators.d.ts"] = true;
n["lib.decorators.legacy.d.ts"] = true;
n["lib.dom.d.ts"] = true;
n["lib.dom.iterable.d.ts"] = true;
n["lib.es2015.collection.d.ts"] = true;
n["lib.es2015.core.d.ts"] = true;
n["lib.es2015.d.ts"] = true;
n["lib.es2015.generator.d.ts"] = true;
n["lib.es2015.iterable.d.ts"] = true;
n["lib.es2015.promise.d.ts"] = true;
n["lib.es2015.proxy.d.ts"] = true;
n["lib.es2015.reflect.d.ts"] = true;
n["lib.es2015.symbol.d.ts"] = true;
n["lib.es2015.symbol.wellknown.d.ts"] = true;
n["lib.es2016.array.include.d.ts"] = true;
n["lib.es2016.d.ts"] = true;
n["lib.es2016.full.d.ts"] = true;
n["lib.es2017.d.ts"] = true;
n["lib.es2017.full.d.ts"] = true;
n["lib.es2017.intl.d.ts"] = true;
n["lib.es2017.object.d.ts"] = true;
n["lib.es2017.sharedmemory.d.ts"] = true;
n["lib.es2017.string.d.ts"] = true;
n["lib.es2017.typedarrays.d.ts"] = true;
n["lib.es2018.asyncgenerator.d.ts"] = true;
n["lib.es2018.asynciterable.d.ts"] = true;
n["lib.es2018.d.ts"] = true;
n["lib.es2018.full.d.ts"] = true;
n["lib.es2018.intl.d.ts"] = true;
n["lib.es2018.promise.d.ts"] = true;
n["lib.es2018.regexp.d.ts"] = true;
n["lib.es2019.array.d.ts"] = true;
n["lib.es2019.d.ts"] = true;
n["lib.es2019.full.d.ts"] = true;
n["lib.es2019.intl.d.ts"] = true;
n["lib.es2019.object.d.ts"] = true;
n["lib.es2019.string.d.ts"] = true;
n["lib.es2019.symbol.d.ts"] = true;
n["lib.es2020.bigint.d.ts"] = true;
n["lib.es2020.d.ts"] = true;
n["lib.es2020.date.d.ts"] = true;
n["lib.es2020.full.d.ts"] = true;
n["lib.es2020.intl.d.ts"] = true;
n["lib.es2020.number.d.ts"] = true;
n["lib.es2020.promise.d.ts"] = true;
n["lib.es2020.sharedmemory.d.ts"] = true;
n["lib.es2020.string.d.ts"] = true;
n["lib.es2020.symbol.wellknown.d.ts"] = true;
n["lib.es2021.d.ts"] = true;
n["lib.es2021.full.d.ts"] = true;
n["lib.es2021.intl.d.ts"] = true;
n["lib.es2021.promise.d.ts"] = true;
n["lib.es2021.string.d.ts"] = true;
n["lib.es2021.weakref.d.ts"] = true;
n["lib.es2022.array.d.ts"] = true;
n["lib.es2022.d.ts"] = true;
n["lib.es2022.error.d.ts"] = true;
n["lib.es2022.full.d.ts"] = true;
n["lib.es2022.intl.d.ts"] = true;
n["lib.es2022.object.d.ts"] = true;
n["lib.es2022.regexp.d.ts"] = true;
n["lib.es2022.sharedmemory.d.ts"] = true;
n["lib.es2022.string.d.ts"] = true;
n["lib.es2023.array.d.ts"] = true;
n["lib.es2023.d.ts"] = true;
n["lib.es2023.full.d.ts"] = true;
n["lib.es5.d.ts"] = true;
n["lib.es6.d.ts"] = true;
n["lib.esnext.d.ts"] = true;
n["lib.esnext.full.d.ts"] = true;
n["lib.esnext.intl.d.ts"] = true;
n["lib.scripthost.d.ts"] = true;
n["lib.webworker.d.ts"] = true;
n["lib.webworker.importscripts.d.ts"] = true;
n["lib.webworker.iterable.d.ts"] = true;
function C(e, t, s = 0) {
  ...
  if (o += e.messageText, s++, e.next) for (const i of e.next) o += C(i, t, s);
  return o;
}
function w(e) {
...
var _ = class {
  ...
  isLibFile(e) {
    return e && e.path.indexOf("/lib.") === 0 ? !!n[e.path.slice(1)] : false;
  }
  getOrCreateModel(e) {
  ...
  constructor(e, t, s, o) {
    ...
    this._libFiles = e, this._defaults = t, this._selector = s;
    const i = (r) => {
      if (r.getLanguageId() !== s) return;
      const g = () => {
    ...
    this._disposables.push(a.editor.onDidCreateModel((r) => i(r))), this._disposables.push(a.editor.onWillDisposeModel(u)), this._disposables.push(a.editor.onDidChangeModelLanguage((r) => {
      ...
      for (const r of a.editor.getModels()) u(r);
    } });
    const c = () => {
      for (const r of a.editor.getModels()) u(r), i(r);
    };
  ...
  _convertDiagnostics(e, t) {
    ...
    return t.reportsUnnecessary && g.push(a.MarkerTag.Unnecessary), t.reportsDeprecated && g.push(a.MarkerTag.Deprecated), { severity: this._tsDiagnosticCategoryToMarkerSeverity(t.category), startLineNumber: i, startColumn: u, endLineNumber: c, endColumn: r, message: C(t.messageText, `
`), code: t.code.toString(), tags: g, relatedInformation: this._convertRelatedInformation(e, t.relatedInformation) };
  }
  _convertRelatedInformation(e, t) {
    ...
    return t.forEach((o) => {
      let i = e;
      if (o.file && (i = this._libFiles.getOrCreateModel(o.file.fileName)), !i) return;
      const u = o.start || 0, c = o.length || 1, { lineNumber: r, column: g } = i.getPositionAt(u), { lineNumber: d, column: p } = i.getPositionAt(u + c);
      s.push({ resource: i.uri, startLineNumber: r, startColumn: g, endLineNumber: d, endColumn: p, message: C(o.messageText, `
`) });
    }), s;
  }
  ...
  async provideCompletionItems(e, t, s, o) {
    ...
    return !d || e.isDisposed() ? void 0 : { suggestions: d.entries.map((b) => {
      ...
      const y = [];
      return b.kindModifiers !== void 0 && b.kindModifiers.indexOf("deprecated") !== -1 && y.push(a.languages.CompletionItemTag.Deprecated), { uri: c, position: t, offset: r, range: h, label: b.name, insertText: b.name, sortText: b.sortText, kind: x.convertKind(b.kind), tags: y };
    }) };
  }
  async resolveCompletionItem(e, t) {
    ...
    return r ? { uri: o, position: i, label: r.name, kind: x.convertKind(r.kind), detail: w(r.displayParts), documentation: { value: x.createDocumentationString(r) } } : s;
  }
  ...
  static createDocumentationString(e) {
    ...
    if (e.tags) for (const s of e.tags) t += `
...
var L = class extends _ {
  ...
  async provideSignatureHelp(e, t, s, o) {
    ...
    if (e.isDisposed()) return;
    const r = await c.getSignatureHelpItems(i.toString(), u, { triggerReason: L._toSignatureHelpTriggerReason(o) });
    if (!r || e.isDisposed()) return;
    const g = { activeSignature: r.selectedItemIndex, activeParameter: r.argumentIndex, signatures: [] };
    return r.items.forEach((d) => {
      const p = { label: "", parameters: [] };
      p.documentation = { value: w(d.documentation) }, p.label += w(d.prefixDisplayParts), d.parameters.forEach((b, h, y) => {
        const S = w(b.displayParts), v = { label: S, documentation: { value: w(b.documentation) } };
...
` + g : "") }] };
  ...
  async provideDocumentHighlights(e, t, s) {
    const o = e.uri, i = e.getOffsetAt(t), u = await this._worker(o);
    if (e.isDisposed()) return;
    const c = await u.getDocumentHighlights(o.toString(), i, [o.toString()]);
    if (!(!c || e.isDisposed())) return c.flatMap((r) => r.highlightSpans.map((g) => ({ range: this._textSpanToRange(e, g.textSpan), kind: g.kind === "writtenReference" ? a.languages.DocumentHighlightKind.Write : a.languages.DocumentHighlightKind.Text })));
  }
}, $ = class extends _ {
  constructor(e, t) {
  ...
  async provideDefinition(e, t, s) {
    ...
    if (!c || e.isDisposed() || (await this._libFiles.fetchLibFilesIfNecessary(c.map((g) => a.Uri.parse(g.fileName))), e.isDisposed())) return;
    const r = [];
    for (let g of c) {
      const d = this._libFiles.getOrCreateModel(g.fileName);
      d && r.push({ uri: d.uri, range: this._textSpanToRange(d, g.textSpan) });
    }
    return r;
  }
}, z = class extends _ {
  ...
  async provideReferences(e, t, s, o) {
    ...
    if (!r || e.isDisposed() || (await this._libFiles.fetchLibFilesIfNecessary(r.map((d) => a.Uri.parse(d.fileName))), e.isDisposed())) return;
    const g = [];
    for (let d of r) {
      const p = this._libFiles.getOrCreateModel(d.fileName);
      p && g.push({ uri: p.uri, range: this._textSpanToRange(p, d.textSpan) });
    }
    return g;
  }
}, G = class extends _ {
  async provideDocumentSymbols(e, t) {
    ...
    const u = (r, g) => {
      var _a;
      return { name: r.text, detail: "", kind: m[r.kind] || a.languages.SymbolKind.Variable, range: this._textSpanToRange(e, r.spans[0]), selectionRange: this._textSpanToRange(e, r.spans[0]), tags: [], children: (_a = r.childItems) == null ? void 0 : _a.map((p) => u(p, r.text)), containerName: g };
    };
...
`, InsertSpaceAfterCommaDelimiter: true, InsertSpaceAfterSemicolonInForStatements: true, InsertSpaceBeforeAndAfterBinaryOperators: true, InsertSpaceAfterKeywordsInControlFlowStatements: true, InsertSpaceAfterFunctionKeywordForAnonymousFunctions: true, InsertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis: false, InsertSpaceAfterOpeningAndBeforeClosingNonemptyBrackets: false, InsertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces: false, PlaceOpenBraceOnNewLineForControlBlocks: false, PlaceOpenBraceOnNewLineForFunctions: false };
  ...
  async provideDocumentRangeFormattingEdits(e, t, s, o) {
    const i = e.uri, u = e.getOffsetAt({ lineNumber: t.startLineNumber, column: t.startColumn }), c = e.getOffsetAt({ lineNumber: t.endLineNumber, column: t.endColumn }), r = await this._worker(i);
    if (e.isDisposed()) return;
    const g = await r.getFormattingEditsForRange(i.toString(), u, c, k._convertOptions(s));
    if (!(!g || e.isDisposed())) return g.map((d) => this._convertTextChanges(e, d));
  }
}, Q = class extends k {
...
`];
  ...
  async provideCodeActions(e, t, s, o) {
    const i = e.uri, u = e.getOffsetAt({ lineNumber: t.startLineNumber, column: t.startColumn }), c = e.getOffsetAt({ lineNumber: t.endLineNumber, column: t.endColumn }), r = k._convertOptions(e.getOptions()), g = s.markers.filter((h) => h.code).map((h) => h.code).map(Number), d = await this._worker(i);
    if (e.isDisposed()) return;
    const p = await d.getCodeFixesAtPosition(i.toString(), u, c, g, r);
    return !p || e.isDisposed() ? { actions: [], dispose: () => {
    } } : { actions: p.filter((h) => h.changes.filter((y) => y.isNewFile).length === 0).map((h) => this._tsCodeFixActionToMonacoCodeAction(e, s, h)), dispose: () => {
    } };
  }
  _tsCodeFixActionToMonacoCodeAction(e, t, s) {
    const o = [];
    for (const u of s.changes) for (const c of u.textChanges) o.push({ resource: e.uri, versionId: void 0, textEdit: { range: this._textSpanToRange(e, c.span), text: c.newText } });
    return { title: s.description, edit: { edits: o }, diagnostics: t.markers, kind: "quickfix" };
  }
}, X = class extends _ {
  constructor(e, t) {
    super(t), this._libFiles = e;
  ...
  async provideRenameEdits(e, t, s, o) {
    ...
    if (e.isDisposed()) return;
    const g = await r.getRenameInfo(u, c, { allowRenameOfImportPath: false });
    if (g.canRename === false) return { edits: [], rejectReason: g.localizedErrorMessage };
    if (g.fileToRename !== void 0) throw new Error("Renaming files is not supported.");
    const d = await r.findRenameLocations(u, c, false, false, false);
    if (!d || e.isDisposed()) return;
    const p = [];
    for (const b of d) {
      const h = this._libFiles.getOrCreateModel(b.fileName);
      if (h) p.push({ resource: h.uri, versionId: void 0, textEdit: { range: this._textSpanToRange(h, b.textSpan), text: s } });
  ...
  async provideInlayHints(e, t, s) {
    const o = e.uri, i = o.toString(), u = e.getOffsetAt({ lineNumber: t.startLineNumber, column: t.startColumn }), c = e.getOffsetAt({ lineNumber: t.endLineNumber, column: t.endColumn }), r = await this._worker(o);
    return e.isDisposed() ? null : { hints: (await r.provideInlayHints(i, u, c)).map((p) => ({ ...p, label: p.text, position: e.getPositionAt(p.position), kind: this._convertHintKind(p.kind) })), dispose: () => {
    } };
  }
  _convertHintKind(e) {
    switch (e) {
