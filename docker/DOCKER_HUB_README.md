...
| `WRIGHT_API_TOKEN` | Yes | None | Unique installation token generated by the operator. Startup fails when absent. |
| `API_SERVER_KEY` | No | Generated per start | Optional override for Wright-to-Hermes internal authentication. |
...
| :--- | :--- | :--- |
| `wright_data` | `/home/agent/.local/share/wright` | SQLite and Wright application state. |
| `wright_workspaces` | `/home/agent/workspace` | User workspaces and artifacts. |
| `wright_config` | `/home/agent/.config/wright` | Wright configuration and protected fallback secrets. |
| `wright_hermes` | `/home/agent/.hermes` | Hermes profiles and sessions. |
