...
|:---|:---|:---|:---|
| Hermes Agent | v0.19.x | 8642 (gateway API) | `systemctl --user start hermes-gateway-wright` |
...
| **AI Agent** | hermes-agent (PyPI) | 0.19.0 |
...
graph LR
    ...
    subgraph "Stage 2: Runtime"
        ...
        UV --> HERMES_INSTALL["uv tool install<br/>hermes-agent==0.19.0<br/>--with hermes-plugin-wright"]
...
| Component | Version | Port | How It's Started |
|:---|:---|:---|:---|
| Hermes Desktop | v0.19.x | — | Launched by user (Electron App) |
...
| **Hermes version** | v0.19.x (local) | v0.19.0 (pinned in image) | User's existing version | User's desktop app version |
...
graph TB
    ...
    subgraph "External Dependencies"
        HERMES["hermes-agent<br/>(PyPI, v0.19.x)"]
