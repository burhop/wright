...
**Boundary:** planning/program tooling only; no process-runtime or benchmark collection. Reject cycles, missing references, digest mismatch, stale approvals, impossible transitions, WIP/lease conflicts, hand-set aggregate green, and unknown schema majors. Historical disposition is limited to four independently closed profiles: V4 37 claims, V5 one TR-0027 claim, V7 two repair-evidence claims, and—only after separate V8 approval—three T072 checkpoint claims. V8 also permits only the final catalog rebind and two walkthrough causes. All preserve original bytes/findings and cannot alter lifecycle, readiness, benchmark, authority, freshness, candidate, delivery, or release results.
