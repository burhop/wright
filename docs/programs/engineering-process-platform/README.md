...
11. <a href="../../../specs/076-control-plane-validator/spec.md"><code>spec.md</code></a>, <a href="../../../specs/076-control-plane-validator/plan.md"><code>plan.md</code></a>, <a href="../../../specs/076-control-plane-validator/tasks.md"><code>tasks.md</code></a>, completed <a href="../../../specs/076-control-plane-validator/checklists/requirements.md">requirements checklist</a>, <a href="../../../specs/076-control-plane-validator/checklists/program-control.md">program-control checklist</a>, and current <a href="../../../specs/076-control-plane-validator/analysis.md"><code>analysis.md</code></a> — the bounded 80-task EPP-F01 subject frozen at candidate F; integration-only corrections may follow without changing its feature scope.
