...
15. [`evidence/transitions/TR-0026.json`](evidence/transitions/TR-0026.json), [`evidence/approvals/APR-EPP-F01-REPAIR-PLANNING-001.json`](evidence/approvals/APR-EPP-F01-REPAIR-PLANNING-001.json), [`evidence/corrections/COR-EPP-F01-US1-COMMITTED-IDENTITY-001.json`](evidence/corrections/COR-EPP-F01-US1-COMMITTED-IDENTITY-001.json), [`decisions/0016-closed-committed-identity-correction.md`](decisions/0016-closed-committed-identity-correction.md), and [`audits/2026-08-27-epp-f01-committed-identity-repair-audits.md`](audits/2026-08-27-epp-f01-committed-identity-repair-audits.md) — the exact discovery checkpoint, planning-only authority, literal 37-claim proposal, still-open DEC-P0-016, and independent omission reviews. None is implementation authority.
