...
**Status:** IMPLEMENTATION AUTHORIZED for local T073–T076 under lease revision 12. Exact V8 approvals bind the three immutable checkpoint claims, final gate-evidence catalog rebind, and two evidence-walkthrough causes. The roadmap-policy defect, T066–T068, and EPP-F01B implementation remain outside this lease.
...
Start EPP-F01 implementation at T073 under lease revision 12, then execute T074–T076 in order. Stop if the six-target boundary expands or the two-repair limit is exhausted. The roadmap-policy defect, T066–T068, dependencies, benchmark generation/execution, product or EPP-F01B implementation, external change, push/PR/merge/dev integration, publication, and release remain unauthorized under this lease.
