...
**Status:** Exact V7 approval accepts DEC-P0-018 and authorizes only local T070–T072 plus one subsequent independent T066 retry. The immutable repair-evidence defects remain visible; the validator stays fail-closed until the exact correction passes. T067–T068 and EPP-F01B implementation remain unauthorized.
...
19. [`evidence/corrections/COR-EPP-F01-REPAIR-EVIDENCE-001.json`](evidence/corrections/COR-EPP-F01-REPAIR-EVIDENCE-001.json), [`decisions/0018-closed-repair-evidence-correction.md`](decisions/0018-closed-repair-evidence-correction.md), [`evidence/approvals/APR-EPP-F01-MC-007.json`](evidence/approvals/APR-EPP-F01-MC-007.json), and [`evidence/approvals/APR-EPP-F01-IMPL-007.json`](evidence/approvals/APR-EPP-F01-IMPL-007.json) — the exact two-claim correction and bounded V7 authority.
...
Execute T070 test-first, implement only the exact correction in T071, and complete the T072 verification/freeze. A passing unchanged candidate then permits one distinct independent T066 retry. Dependencies, benchmark execution, product or EPP-F01B implementation, T067–T068, external change, push/PR/merge/dev integration, publication, and release remain unauthorized.
