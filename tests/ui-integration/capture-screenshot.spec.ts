...
test("capture all screenshots", async ({ page }, testInfo) => {
  ...
  await page.screenshot({
    path: path.join(screenshotDir, "screenshot_initial.png"),
  });
  ...
  await page.screenshot({
    path: path.join(screenshotDir, "screenshot_agent_chat.png"),
  });
  ...
  await page.waitForTimeout(2000);
  await page.screenshot({
    path: path.join(screenshotDir, "screenshot_tool_registry.png"),
  });
  ...
  await page.waitForTimeout(2000);
  await page.screenshot({
    path: path.join(screenshotDir, "screenshot_file_vault.png"),
  });
