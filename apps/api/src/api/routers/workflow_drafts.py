...
async def _parse_body(request: Request, model: type[_Model]) -> _Model | JSONResponse:
...
@router.post("/{draft_id}/validate", dependencies=[Depends(require_engineer_or_admin)])
